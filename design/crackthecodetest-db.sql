...
-- Schema CrackTheCodeDB
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `CrackTheCodeDBTest` DEFAULT CHARACTER SET utf8 ;
USE `CrackTheCodeDBTest` ;

-- -----------------------------------------------------
-- Table `CrackTheCodeDB`.`game`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `CrackTheCodeDBTest`.`game` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `CrackTheCodeDBTest`.`round` (
